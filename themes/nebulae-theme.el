 ...
 ((((class color) (min-colors #xFF)))
  ...
  ((default               (:foreground lightgray :background lightblack))
   (cursor                (:foreground lightblack :background lightgray))
	 ...
	 (lsp-ui-doc-background  (:background darkblack))

	 ;(company-preview)
	 ;(company-preview-common)
	 ;(company-preview-search)
	 (company-scrollbar-bg                      (:background darkblack))
	 (company-scrollbar-fg                      (:background darkgray))
	 (company-tooltip                           (:foreground lightgray :background darkblack))
	 (company-tooltip-selection                 (:foreground lightblack :background lightgray))
	 (company-tooltip-annotation                (:foreground darkgray))
	 (company-tooltip-annotation-selection      (:foreground darkblack))
